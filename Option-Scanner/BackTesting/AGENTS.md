...
## 10. Expiry Rules (CRITICAL)
- NIFTY Options have migrated and now expire on **TUESDAYS**. 
- Always ensure any expiry-day logic (zero time value, theta decay spikes) is mapped to Tuesday, not Thursday.
